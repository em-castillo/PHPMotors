...
// Function inserts a new classification to the carclassifications table.
...
// Function inserts a new vehicle to the inventory table.
...
// Get vehicle information by invId - selects a single vehicle
...
// Function updates a vehicle in the inventory table.
...
// Function deletes a vehicle in the inventory table.
...
//Function gets a list of vehicles based on the classification.
...
// Gets detailed info from each car through a link
function getDetailedInfo($invId)
{
    $db = phpmotorsConnect();
    // $sql = 'SELECT * FROM inventory WHERE invId = :invId';
